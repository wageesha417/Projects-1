...
<div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="content text-center ms-0 m-0">
                            <div class="col-12">
                                ...
                                <span class="card-text price productName">$ <?php echo $selected_data["price"]; ?></span>
    ...
    <div class="offset-2 offset-lg-3 col-8 col-lg-6 text-center mb-3">
        ...
        <div class="pagination">
            ...
            <a <?php if ($pageno <= 1) {
                    echo ("#");
                } else { ?> onclick="basicSearch(<?php echo ($pageno - 1) ?>);" <?php } ?>>
                &laquo;</a>
            ...
            ?>
                    <a class="active" onclick="basicSearch(<?php echo ($x) ?>);"><?php echo $x; ?></a>
                <?php
            ...
            <a <?php if ($pageno <= 1) {
                    echo ("#");
                } else { ?> onclick="basicSearch(<?php echo ($pageno + 1) ?>);" <?php } ?>>&raquo;</a>
